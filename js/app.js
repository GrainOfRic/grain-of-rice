(() => {
    ...
    (() => {
        ...
        if (window.location.pathname.includes("cart-page.html") || window.location.pathname.includes("product-page.html")) footerLogo.style.display = "none"; else footerLogo.style.display = "block";
        ...
        if (window.location.href.includes("cart-page.html")) {
            ...
            deliveryOptions.forEach((option => {
                option.addEventListener("change", (() => {
                    if ("Доставка" === option.value) {
                        console.log("Доставка");
                        addressInput.style.display = "block";
                    } else if ("Самовивіз" === option.value) {
                        addressInput.style.display = "none";
                        distanceDiv.style.display = "none";
                        deliveryPriceDiv.style.display = "none";
